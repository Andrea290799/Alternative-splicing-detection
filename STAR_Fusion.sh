...
do
    ...
    $(FusionInspector --fusions ${sample}_star_fusion_outdir/star-fusion.fusion_predictions.tsv  \
                --genome_lib ./GRCh38_gencode_v37_CTAT_lib_Mar012021.plug-n-play/ctat_genome_lib_build_dir \
                --left_fq ${samples[0]} --right_fq ${samples[0]} \
                --out_dir ${sample}_FusionInspector_outdir \
